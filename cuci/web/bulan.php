...
<html lang="en">
  ...
  <body>
      ...
      <center><table class="table-bordered mt-4" width="1000px">
         ...
         <td><center>Hapus</td>
           ...
           <?php
              ...
              <td><center><a href="delete_bulan.php?id=<?php echo $row['id'] ?>"><button type="button" class="btn btn-warning">
    ...
    <a href="export_bulan.php"><button type="button" class="btn btn-info mt-4">
