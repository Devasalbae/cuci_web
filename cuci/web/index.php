...
<!-- ini navbar Bosq-->
    ...
    <?php
    echo "<font color='white' size='4px'>".date('l,d-m-y') ;
    echo "</font>";
     ?>
      </div>
    </nav>
...
<h2><p class="text-center">Tambah Costumer</p></h2>
...
<button type="submit" class="btn btn-primary btn-sm btn-block mt-4" name='kirim'>Kirim</button>
...
<?php
 ...
 if($insert){
   echo  "<center> <div class='sukses'> ";
   echo "<h2><center>Sukses Kirim</center></h2>";
   echo "<hr><center>";
   echo "<p>Terima kasih atas kepercayaannya terhadap kami, barang anda akan segera kami proses dan akan menghubungi anda jika sudah selesai";
   echo " ";
