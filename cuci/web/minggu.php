...
<h3><p class="text-center mt-4">Data Masuk Minggu Ini</p></h3>
  ...
  <center><table class="table-bordered mt-4" width="1280px">
      <tr>
     <td><center>No</td>
 		 <td><center>Nama</td>
 		 <td><center>Alamat</td>
     ...
     <td><center>Print</td>
       ...
       <?php
          ...
          <td><center><a href="https://api.whatsapp.com/send?phone=<?php echo $row['nomor'];?>&text=Assalamualaikum%20<?php echo $row['nama'] ?>%20Barang%20Anda%20Selesai%20DiLaundry "><button type="button" class="btn btn-success">
            ...
            Hubungi</button></a></td>
          <td><center><a href="delete.php?id=<?php echo $row['id'] ?>"><button type="button" class="btn btn-warning">
            <svg class="bi bi-trash" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
              <path d="M5.5 5.5A.5.5 0 0 1 6 6v6a.5.5 0 0 1-1 0V6a.5.5 0 0 1 .5-.5zm2.5 0a.5.5 0 0 1 .5.5v6a.5.5 0 0 1-1 0V6a.5.5 0 0 1 .5-.5zm3 .5a.5.5 0 0 0-1 0v6a.5.5 0 0 0 1 0V6z"/>
              <path fill-rule="evenodd" d="M14.5 3a1 1 0 0 1-1 1H13v9a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V4h-.5a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1H6a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1h3.5a1 1 0 0 1 1 1v1zM4.118 4L4 4.059V13a1 1 0 0 0 1 1h6a1 1 0 0 0 1-1V4.059L11.882 4H4.118zM2.5 3V2h11v1h-11z"/>
            </svg>
            Hapus</button></a></td>
          <td><center><a href="print.php"><button type="button" class="btn btn-primary"><svg class="bi bi-file-text" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
